...
$id=$_GET['id'];
  ...
  $sql="SELECT * FROM  parktype where id='$id'";
...
if(isset($_POST['customer']))
{
    $park_name=$_POST['name'];
       $customer_update = "UPDATE parktype SET 
       park_name='$park_name'
       WHERE id='$id'";
...
?>
    ...
    <input type="text" class="form-control" required name="name" id="name" aria-describedby="fname" value='<?=$user['park_name']?>' placeholder="Park Name *">
  </div>
